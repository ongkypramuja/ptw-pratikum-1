    ...
    <div class="container" id="home">
      <div class="col-12 text-center">
        <div class="tm-page-header">
          <i class=""></i>
          <h1 class="d-inline-block text-uppercase">Ongky Pramuja 0074</h1>
        </div>
      </div>
    </div>
    <!-- navbar -->
            ...
            <nav class="navbar navbar-expand-md navbar-light">
              ...
              <div class="collapse navbar-collapse" id="tmMainNav">
                <ul class="navbar-nav mx-auto tm-navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#features">Konten</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#company">about me</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#contact">Contact saya</a>
                  </li>
                </ul>
              </div>
            </nav>
    ...
    <section class="tm-banner-section" id="tmVideoSection">
      <div class="container tm-banner-text-container">
        <div class="row">
          <div class="col-12">
            <header>
              <h2 class="tm-banner-title">Selamat datang di blog saya</h2>
              <p class="mx-auto tm-banner-subtitle">
              semoga menikmati konten saya
              </p>
            </header>
          </div>
        </div>
      ...
      <video id="hero-vid" autoplay="" loop="" muted>
       ...
       video tidak support browser anda
      </video>
    </section>
    <!-- Features -->
    <div class="container tm-features-section" id="features">
      <div class="row tm-features-row">
        <section class="col-md-6 col-sm-12 tm-feature-block">
          ...
          <p>
          Berisi rangkaian instruksi yang menentukan bagiamana suatu text akan ditampilkan pada halaman web. 
          Perancangan desain text dapat dilakukan dengan mendefinisikan 
          fonts (huruf) , colors (warna), margins (ukuran), latar belakang (background), ukuran font (font sizes)
          </p>
        </section>
        <section class="col-md-6 col-sm-12 tm-feature-block">
          <header class="tm-feature-header">
            <h3 class="tm-feature-h">PHP</h3>
          </header>
          <p>
          ...
          PHP diciptakan oleh Rasmus Lerdorf pertama kali tahun 1994. Pada awalnya PHP adalah singkatan dari "Personal Home Page Tools". 
          Selanjutnya diganti menjadi FI ("Forms Interpreter"). Sejak versi 3.0, nama bahasa ini diubah menjadi "PHP: Hypertext Prepocessor" dengan singkatannya "PHP". PHP versi terbaru adalah versi ke-5.
          </p>
        ...
        <div class="col-xl-9 col-lg-8 col-md-12 tm-company-left">
          <div class="tm-company-about">
            <div class="tm-company-img-container">
              <img src="img/4x6.jpg" alt="Image" />
            </div>
            <div class="tm-company-about-text">
              <header>
                <h2 class="tm-company-about-header">About me</h2>
              </header>
              <p>
                nama : Ongky pramuja
              </p>
              ...
              <p>
                email : pramujaongky@gmail.com
              </p>
              <p class="mb-4">
                hai saya pembuat website ini
              </p>
      ...
      <div class="row">
        <div class="col-xl-5 col-lg-6 col-md-12 tm-contact-left">
          <div class="tm-contact-form-container ml-auto mr-0">
            <header>
              <h2 class="tm-contact-header">Contact saya</h2>
            </header>
    ...
    <footer class="container tm-footer">
      <div class="row tm-footer-row">
        <p class="col-md-10 col-sm-12 mb-0">
          ...
          <a rel="nofollow" href="https://www.facebook.com/ongkypramuja" class="tm-footer-link">Ongky Pramuja</a>
        </p>
